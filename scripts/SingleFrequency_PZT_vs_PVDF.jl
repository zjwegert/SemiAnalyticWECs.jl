...
fig = with_theme(theme_latexfonts(),fontsize=28,linewidth=3) do
  ...
  # ylims!(ax41_r,-1500,1500)
  # ylims!(ax41_l,-1500,1500)
  hidespines!(ax21_r)
  ...
  ax41 = Axis(fig[4,1],width=400,height=150,xlabel=L"x~(\mathrm{m})",ylabel=L"\mathrm{Re(q)~(C)}",xticks=-10:5:10)
  ...
  # ylims!(ax42_r,-750,750)
  # ylims!(ax42_l,-750,750)
  hidespines!(ax22_r)
  ...
  ax42 = Axis(fig[4,2],width=400,height=150,xlabel=L"x~(\mathrm{m})",ylabel=L"\mathrm{Im(q)~(C)}",xticks=-10:5:10)
